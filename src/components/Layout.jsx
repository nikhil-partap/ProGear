...
export function ScrollTop() {
  ...
  useEffect(() => {
    ...
    const titles = { '/': 'Premium Car Mats, Made for Your Drive', '/shop': 'Shop All Collections', '/about': 'Our Story', '/contact': 'Contact & Support', '/gallery': 'Customer Photos', '/cart': 'Your Cart', '/replacement-policy': 'Replacement Policy', '/policies': 'Replacement Policy', '/terms': 'Terms & Conditions' };
...
export function Footer() {
  return <footer className="site-footer">
    <div className="page footer-grid">
      ...
      <nav className="footer-link-group" aria-label="Footer support"><h3>Explore & help</h3><Link to="/gallery">Customer gallery</Link><Link to="/about">Our story</Link><Link to="/replacement-policy">Replacement policy</Link><Link to="/contact">Contact us</Link></nav>
